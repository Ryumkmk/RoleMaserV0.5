...
restgatekeeper.textContent += (gatekeeper || "") + (gatekeeper && parkkeeper1 ? "," : "") + (parkkeeper1 || "") + (parkkeeper1 && parkkeeper2 ? "," : "") + (parkkeeper2 || "");
const restcloak = document.querySelector(".rest-cloak");
restcloak.textContent += (cloak || "") + (cloak && returnleader ? "," : "") + (returnleader || "") + (returnleader && cloaksub ? "," : "") + (cloaksub || "");
...
restdrink.textContent += (drinkmain || "") + (drinkmain && drinksub ? "," : "") + (drinksub || "") + (drinksub && drinksubsub ? "," : "") + (drinksubsub || "");
const restchampagne = document.querySelector(".rest-champagne");
restchampagne.textContent += (champagne1 || "") + (champagne1 && champagne2 ? "," : "") + (champagne2 || "") + (champagne2 && toiletlady ? "," : "") + (toiletlady || "");
...
restape.textContent += (ape1 || "") + (ape1 && ape2 ? "," : "") + (ape2 || "") + (ape2 && toiletman ? "," : "") + (toiletman || "");
...
restgatekeeperP.textContent += (gatekeeperP || "") + (gatekeeperP && parkkeeper1P ? "," : "") + (parkkeeper1P || "") + (parkkeeper1P && parkkeeper2P ? "," : "") + (parkkeeper2P || "");
const restcloakP = document.querySelector(".rest-cloakP");
restcloakP.textContent += (cloakP || "") + (cloakP && returnleaderP ? "," : "") + (returnleaderP || "") + (returnleaderP && cloaksubP ? "," : "") + (cloaksubP || "");
...
restdrinkP.textContent += (drinkmainP || "") + (drinkmainP && drinksubP ? "," : "") + (drinksubP || "") + (drinksubP && drinksubsubP ? "," : "") + (drinksubsubP || "");
const restchampagneP = document.querySelector(".rest-champagneP");
restchampagneP.textContent += (champagne1P || "") + (champagne1P && champagne2P ? "," : "") + (champagne2P || "") + (champagne2P && toiletladyP ? "," : "") + (toiletladyP || "");
...
restapeP.textContent += (ape1P || "") + (ape1P && ape2P ? "," : "") + (ape2P || "") + (ape2P && toiletmanP ? "," : "") + (toiletmanP || "");

...
restgatekeeper.textContent += gatekeeper;
restgatekeeper.textContent += parkkeeper1;
restgatekeeper.textContent += parkkeeper2;
const restcloak = document.querySelector(".rest-cloak");
restcloak.textContent += cloak;
restcloak.textContent += returnleader;
restcloak.textContent += cloaksub;
...
restdrink.textContent += drinkmain;
restdrink.textContent += drinksub;
restdrink.textContent += drinksubsub;
const restchampagne = document.querySelector(".rest-champagne");
restchampagne.textContent += champagne1;
restchampagne.textContent += champagne2;
restchampagne.textContent += toiletlady;
const restsilver = document.querySelector(".rest-silver");
restsilver.textContent += silver1;
restsilver.textContent += silver2;
const restape = document.querySelector(".rest-ape");
restape.textContent += ape1;
restape.textContent += ape2;
restape.textContent += toiletman;
...
restgatekeeperP.textContent += gatekeeperP;
restgatekeeperP.textContent += parkkeeper1P;
restgatekeeperP.textContent += parkkeeper2P;
const restcloakP = document.querySelector(".rest-cloakP");
restcloakP.textContent += cloakP;
restcloakP.textContent += returnleaderP;
restcloakP.textContent += cloaksubP;
...
restdrinkP.textContent += drinkmainP;
restdrinkP.textContent += drinksubP;
restdrinkP.textContent += drinksubsubP;
const restchampagneP = document.querySelector(".rest-champagneP");
restchampagneP.textContent += champagne1P;
restchampagneP.textContent += champagne2P;
restchampagneP.textContent += toiletladyP;
const restsilverP = document.querySelector(".rest-silverP");
restsilverP.textContent += silver1P;
restsilverP.textContent += silver2P;
const restapeP = document.querySelector(".rest-apeP");
restapeP.textContent += ape1P;
restapeP.textContent += ape2P;
restapeP.textContent += toiletmanP;
